...
const ViewModal: React.FC<ViewModalProps> = ({ title, layout, content, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50" onClick={handleOutsideClick}>
      <div ref={modalRef} className="bg-white dark:bg-gray-800 p-6 rounded-lg w-full max-w-lg shadow-xl">
